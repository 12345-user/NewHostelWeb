...
export const demoActivities = [
  {
    ...
    description:
      "这个周末，我们在客栈后院点燃了篝火，邀请来自不同城市的旅人围坐在一起。大家分享旅行故事，陌生人之间的距离被火光、热茶和笑声慢慢拉近。",
  ...
  },
  {
    ...
    description:
      "我们邀请当地手工艺人来到客栈，教大家制作属于自己的陶器。从拉坯到塑形，每一个环节都充满乐趣。作品烧制完成后，也会成为旅途中独一无二的纪念。",
  ...
  },
  {
    ...
    description:
      "春天的阳光正好，我们租了几辆复古自行车，沿着古城石板路慢慢骑行，在桥下分享三明治和柠檬水。慢节奏的旅行，也能留下很深的记忆。",
...
export const demoItems = [
  {
    ...
    name: "复古旅行背包",
    date: "2026-01-10",
    description: "来自 1970 年代的皮质背包，见证过许多旅程，如今安静地挂在客栈门厅。",
  ...
  },
  {
    ...
    name: "旅者留言笔记本",
    date: "2026-03-01",
    description: "放在图书角的留言本，写满来自各地旅人的句子和祝福。",
